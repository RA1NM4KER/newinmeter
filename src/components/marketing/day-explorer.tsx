...
const values = [
  ...
  0.22, 0.24, 0.31, 0.46, 0.68, 0.82, 0.74, 0.51, 0.32, 0.25, 0.31, 0.88, 1.46, 0.96
];
...
const windows: Record<WindowId, { label: string; start: number; end: number; time: string; insight: string }> = {
  ...
  lateNight: {
    ...
    time: "21:30–23:00",
    insight: "22:00–22:30 was the day's largest late-night spike."
  }
};
...
export function DayExplorer() {
  ...
  return (
    <section id="understand-day" aria-labelledby="day-heading" className="bg-brandTeal text-white">
      <div className="mx-auto max-w-[86rem] px-5 py-16 sm:px-8 sm:py-20 lg:px-12">
        <div className="grid gap-10 lg:grid-cols-[0.62fr_1.38fr] lg:gap-16">
          <div className="lg:pt-2">
            <p className="text-xs font-semibold uppercase tracking-[0.18em] text-white/60">Day detail · Tuesday</p>
            <h2 id="day-heading" className="mt-4 max-w-md text-3xl font-semibold tracking-[-0.04em] sm:text-5xl">
              Every day has a shape.
            </h2>
            <p className="mt-4 max-w-sm text-base leading-7 text-white/70">
              Pick a part of the day. NewinMeter keeps spend, usage, and time in the same view.
            </p>

            <div className="mt-8 border-y border-white/15 py-5">
              <p className="text-sm text-white/60">{selected.time}</p>
              <div className="mt-3 flex flex-wrap items-baseline gap-x-5 gap-y-2">
                <p className="text-4xl font-semibold tracking-[-0.04em]">{formatRand(spendFor(selectedUsage))}</p>
          ...
          <div className="min-w-0">
            ...
            <div className="relative mt-10 h-64 border-b border-white/25 sm:h-80">
